...
namespace TrickVault.Api.Migrations.Postgres
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patter = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrickCategory", x => new { x.TrickId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Tricks",
                columns: new[] { "Id", "Comments", "Credits", "Effect", "Method", "Patter", "Setup", "Title", "UserId" },
                values: new object[,]
                {
                    { 1, "This is great with children.", "Many poor magicians.", "The magician shows an empty hat, then pulls a rabbit out of it", "Magician shows an empty hat, then reaches into secret compartment and removes hidden rabbit", "Look, the hat is completely empty. Except for this here ribbit!", "Put rabbit in hat", "Pull Rabbit from Hat", "db386051-e294-4d5a-baa5-295a3254be6a" },
                    { 2, null, null, "Magician has audience member select a random card. The card is shuffled back into the deck. Then the magician finds the selected card.", "Spectator selects a card. The card is returned to the deck and the deck is then shuffled. Then through secret means (not given here), the magician is able to find the selected card.", "Pick a card, any card! Show the audience. Now put it back anywhere in the deck. I'm going to shuffle the cards a few times. Now, I couldn't possibly know the location of your card, right? Yet here it is!", null, "Pick a Card", "db386051-e294-4d5a-baa5-295a3254be6a" }
                });
